...
|---|---|---|
| Registration & Shop Discovery | US-01–09 | MVP |
| PIN & Biometric | US-10–15 | MVP |
| Onboarding Wizard | US-16–22 | MVP |
| Overview | US-23–30 | MVP |
| POS & Selling | US-31–39 | MVP |
| Quick Order | US-40–43 | MVP |
| Order Management | US-44–46 | MVP |
| Expenses | US-47–53 | MVP |
| Reports | US-54–58 | MVP |
| Notifications | US-59–62 | MVP |
| Customer Management | US-63–67 | MVP |
| Products | US-68–71 | MVP |
| Inventory | US-72–74 | MVP (INVENTORY shops only) |
| Combos | US-75–78 | MVP |
| Print Templates | US-79–83 | MVP |
| Settings & Profile | US-84–93 | MVP |
| Security Settings | US-94–96 | MVP |
| Activity Log | US-97–99 | MVP |
...
| Bank Transfer QR | US-112–114 | MVP |
| Account Deletion | US-115–116 | MVP |
| Gold Prices | US-117–119 | MVP (JEWELRY only) |
| First-Use Empty States | US-120 | MVP |

---

## Epic 27 — Feedback (FEEDBACK feature)
...
## Epic 28 — Notification Preferences (NOTIFICATION feature)
...
## Epic 30 — Product Category Management (PRODUCT feature)
...
## Epic 31 — Bank Account Management (SHOP_SETTING feature)
...
## Epic 32 — Shop Logo Upload (SHOP_SETTING feature)
...
## Epic 33 — Loyalty Points Redemption (CUSTOMER feature)
...
## Epic 34 — Product Visibility (PRODUCT feature)
...
| PIN & Biometric | US-10–15 | — | MVP |
| Onboarding Wizard | US-16–22 | — | MVP |
| Overview | US-23–30 | DASHBOARD | MVP |
| POS & Selling | US-31–39 | POS | MVP |
| Quick Order | US-40–43 | POS | MVP |
| Order Management | US-44–46 | ORDER | MVP |
| Expenses | US-47–53 | — | MVP |
| Reports | US-54–58 | DASHBOARD | MVP |
| Notifications | US-59–62 | NOTIFICATION | MVP |
| Customer Management | US-63–67, US-150–151 | CUSTOMER | MVP |
| Products | US-68–71 | PRODUCT | MVP |
| Inventory | US-72–74 | INVENTORY | MVP |
| Combos | US-75–78 | POS | MVP |
| Print Templates | US-79–83 | SHOP_SETTING | MVP |
| Settings & Profile | US-84–93 | — | MVP |
| Security Settings | US-94–96 | — | MVP |
| Activity Log | US-97–99 | ACTIVITY_LOG | MVP |
| Subscription | US-100–102 | — | MVP |
| App Launch & Reliability | US-103–107 | — | MVP |
| Forgot Password | US-108–109 | — | MVP |
| Language Selection | US-110–111 | — | MVP |
| Bank Transfer QR | US-112–114 | SHOP_SETTING | MVP |
| Account Deletion | US-115–116 | — | MVP |
| Gold Prices | US-117–119 | PAWN | MVP |
| First-Use Empty States | US-120 | — | MVP |
...
| Hôm qua on HomeScreen | US-141 | DASHBOARD | MVP |
...
|---|---|---|
| DASHBOARD | US-23–30, US-54–58 | ✅ |
| POS | US-31–43, US-75–78, US-88 | ✅ |
| ORDER | US-44–46, US-124 | ✅ |
| PRODUCT | US-68–71, US-125–126, US-131, US-149 | ✅ |
| INVENTORY | US-72–74 | ✅ |
| CUSTOMER | US-63–67, US-130, US-148, US-150–151 | ✅ |
| NOTIFICATION | US-59–62, US-123 | ✅ |
| FEEDBACK | US-121–122 | ✅ |
